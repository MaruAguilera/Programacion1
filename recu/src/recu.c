...
int main(void) {
	...
	//	LinkedList* listaComputerFiltrados = ll_newLinkedList();
		do
		{
			...
			switch(opcionMenu)
			{
				case 1://NOTE OLVIDES DE PREGUNTAR EL NOMBRE DEL ARCHIVO

					if(controller_loadFromText("/home/alumno/Descargas/Marisa/bicicletas_v3.csv",listaComputer)==0){
						printf("TODO OK, LEYO EL ARCHIVO");
					}
